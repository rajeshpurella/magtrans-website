    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          <h2 className="font-montserrat font-semibold text-2xl md:text-3xl tracking-tight text-zinc-900">
            Core Engineering Domains
          </h2>
          <p className="mt-4 text-zinc-600 text-base md:text-lg leading-relaxed">
            Three pillars of precision engineering — process cooling, magnetic testing and cryogenic
            platforms — presented as immersive, future-ready systems.
          </p>
        </div>
